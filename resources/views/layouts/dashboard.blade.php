 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('') }}">CONCEPTRECALL</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li {{ (Request::is('*create_cheque') ? 'class="active"' : '') }}>
                            <a href="{{ url ('create_cheque') }}"> Create Cheque</a>
                            <!-- /.nav-second-level -->
                        </li>
                        <li {{ (Request::is('*cheques_list') ? 'class="active"' : '') }}>
                            <a href="{{ url ('cheques_list') }}"> Cheques List</a>
                            <!-- /.nav-second-level -->
                        </li>
                        @if(Auth::user()->user_level === 1)
                        <li {{ (Request::is('*cheque_approval') ? 'class="active"' : '') }}>
                            <a href="{{ url ('cheques_approval') }}"> Cheques Approval</a>
                        </li>
                        @endif
                    </ul>
                </div>
